...
function checkTime() {
  if (playerGuessArray.length == questionQuantity) {
    clearInterval(timer);
...
function createEquations() {
  ...
  const correctEquations = getRandomInt(questionQuantity);
  // console.log("Correct Equations :", correctEquations);
  // Set amount of wrong equations
  const wrongEquations = questionQuantity - correctEquations;
...
function selectQuestionQuantity(e) {
  e.preventDefault();
  questionQuantity = getRadioValue();
  // console.log("no. of questions :", questionQuantity);
  if (questionQuantity) {
    showCountdown();
  }
}
...
startForm.addEventListener("submit", selectQuestionQuantity);
gamePage.addEventListener("click", startTimer);
